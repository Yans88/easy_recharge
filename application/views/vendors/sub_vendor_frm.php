...
<div class="box box-success">
                            ...
                            <tr style="vertical-align:middle;">
                                ...
                                <td colspan="4">
                                    ...
                                    <input type="hidden" name="id_owner" id="id_owner"
                                           value="<?php echo !empty($owner) ? $owner->id_vendor : ''; ?>"/>
    ...
    <div class="box-footer" style="height:35px;">
        ...
        <div class="pull-right">
            <a href="<?php echo site_url('vendors/list_sub_vendor/' . $owner->id_vendor); ?>">
...
<script type="text/javascript">
    ...
    $('.btn_save').click(function () {
        ...
        if (Number(profit) + Number(sharing) > Number(sharingUpline)) {
            $('.profit_error').text('Jumlah profit dan sharing tidak boleh lebih dari ' + Number(sharingUpline) + '%');
            return false;
        }
        var url = '<?php echo site_url('vendors/simpan_sub_vendor');?>';
        $.ajax({
            url: url,
            data: dt,
            type: 'POST',
            success: function (result) {
                if (result > 0) {
                    ...
                    window.location = '<?php echo site_url('vendors/list_sub_vendor/' . $owner->id_vendor);?>';
                }
            }
        });
    });
