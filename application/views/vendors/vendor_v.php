...
<div class="box box-success">
    <div class="box-header">
        <a href="<?php echo site_url('vendors/add_vendor'); ?>">
            <button class="btn btn-success"><i class="fa fa-plus"></i> Add Vendor</button>
        </a>
    </div>
    <div class="box-body">
        ...
        <table id="example88" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <th style="text-align:center; width:40%">Address</th>
            ...
            if (!empty($vendors)) {
                foreach ($vendors as $m) {
                    ...
                    echo '			
			<a href="' . site_url('vendors/add_vendor/' . $m['id_vendor']) . '" title="Edit"><button class="btn btn-xs btn-success"><i class="fa fa-edit"></i> Edit</button></a>
			<button title="Delete" id="' . $m['id_vendor'] . '" class="btn btn-xs btn-danger del_news"><i class="fa fa-trash-o"></i> Delete</button>		
						</td>';
                    echo '</tr>';
                }
            }
