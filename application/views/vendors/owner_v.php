        ...
        <table id="example88" class="table table-bordered table-striped">
            ...
            if (!empty($vendors)) {
                foreach ($vendors as $m) {
                    ...
                    echo '
			<a href="' . site_url('vendors/list_vendor/' . $m['id']) . '" title="Detail"><button class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> List Vendor</button></a>
			<a href="' . site_url('vendors/add/' . $m['id']) . '" title="Edit"><button class="btn btn-xs btn-success"><i class="fa fa-edit"></i> Edit</button></a>
