...
<div class="modal fade" role="dialog" id="act_dialog">
 ...
 <div class="box-header">
    <a href="<?php echo site_url('merchants/add');?>"><button class="btn btn-success"><i class="fa fa-plus"></i> Add Station</button></a>
</div>
<div class="box-body">
<div class='alert alert-info alert-dismissable' id="success-alert">
	...
	<table id="example88" class="table table-bordered table-striped">
		<thead><tr>
            ...
            <th style="text-align:center; width:20%">Station Name</th>
			...
			<?php 
				...
				if(!empty($merchants)){		
					foreach($merchants as $m){	
						$view_sub = '';
						$info = $m['id_merchants'].'Þ'.$m['nama_merchants'];
						echo '<tr>';
